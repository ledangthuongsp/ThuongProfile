    ...
    return (
        <div className="relative flex flex-col min-h-screen">
            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-center px-4">
                <motion.div
                    className="absolute text-[80vh] items-center mb-36 whitespace-nowrap text-gray-300 font-sans font-bold opacity-50"
                    id='lineback'
                    initial={{ x: 0 }}
                    animate={{
                        x: "-100%",
            ...
            <div className="relative h-screen ">
                ...
                <div className="relative mx-auto flex flex-col md:flex-row items-center justify-center px-16 py-16 h-full">
                    <div className="flex md:w-1/3 justify-center md:justify-end items-center mt-8 md:mt-0  py-36 h-full">
                        <img className="h-full w-3/4 md:w-auto rounded-lg object-cover" src={Aboutme} alt="Avatar" />
                    </div>
                    <div className="flex flex-col justify-center md:w-2/3 bg-opacity-60 bg-white px-16 rounded-lg h-full">
                        <h1 className="text-4xl md:text-6xl font-bold leading-tight py-2 font-sans text-black text-justify">
